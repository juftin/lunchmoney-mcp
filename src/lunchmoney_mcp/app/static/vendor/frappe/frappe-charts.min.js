var frappe = (function () {
    ...
    function p(t, e) {
        return { x: Math.sin(t * Qt) * e, y: Math.cos(t * Qt) * e };
    }
    function f(t) {
    ...
    function C(t, e, i, n) {
        return T("svg", { className: e, inside: t, width: i, height: n });
    }
    function O(t) {
        return T("defs", { inside: t });
    }
    function D(t) {
        var e =
    ...
    function j(t, e, i) {
        ...
        var s = {
            ...
            o = T("g", { transform: "translate(" + t + ", " + e + ")" });
        return (o.appendChild(T("rect", s)), o.appendChild(r), o);
    }
    function I(t, e, i) {
        var n =
                arguments.length > 3 && void 0 !== arguments[3]
        ...
        var s = { className: "legend-dot", cx: 0, cy: 0, r: i, fill: n },
            ...
            o = T("g", { transform: "translate(" + t + ", " + e + ")" });
        return (o.appendChild(T("circle", s)), o.appendChild(r), o);
    }
    function R(t, e, i, n) {
        var a =
                arguments.length > 4 && void 0 !== arguments[4]
    ...
    function B(t, e, i, n) {
        ...
        return (
            (0 !== r && "0" !== r) ||
                (o.style.stroke = "rgba(27, 31, 35, 0.6)"),
            o.appendChild(s),
            o.appendChild(r),
            o
        );
    ...
    function V(t, e, i) {
        ...
        (f(t) || (t = 0),
            ...
            n.offset || (n.offset = 0),
            n.mode || (n.mode = "span"),
            n.stroke || (n.stroke = re),
            n.className || (n.className = ""));
        var a = -1 * ie,
            s = "span" === n.mode ? i + ie : 0;
        return (
            "tick" === n.mode && "right" === n.pos && ((a = i + ie), (s = i)),
            (a += n.offset),
            (s += n.offset),
            B(t, e, a, s, {
                stroke: n.stroke,
    ...
    function U(t, e, i) {
        ...
        (f(t) || (t = 0),
            ...
            n.className || (n.className = ""));
        var a = i + ie,
            s = "span" === n.mode ? -1 * ie : i;
        return (
            "tick" === n.mode && "top" === n.pos && ((a = -1 * ie), (s = 0)),
            Y(t, e, a, s, {
                stroke: n.stroke,
                className: n.className,
                lineType: n.lineType,
    ...
    function G(t, e, i) {
        ...
        var a = T("text", {
                ...
                x: "left" === n.labelPos ? ne : i - d(e, 5) - ne,
                y: 0,
                dy: se / -2 + "px",
                "font-size": se + "px",
                "text-anchor": "start",
    ...
    function q(t, e, i, n) {
        ...
        var o = T("text", {
                className: "chart-label",
                x: "left" === a.labelPos ? ne : i - d(n + "", 4.5) - ne,
                y: 0,
                dy: se / -2 + "px",
                "font-size": se + "px",
                "text-anchor": "start",
        ...
        if (n.regionFill) {
            var u = W(a.svgDefs, i, !0),
                h =
                    ...
                    "," +
                    a.zeroLine;
            l.region = N(h, "region-fill", "none", "url(#" + u + ")");
        }
        return l;
    }
    function $(t, e, i, n) {
    ...
    function et(t, e, i, n) {
        ...
        return (
            ...
            "rect" !== t.nodeName
                ? [
                      [t.childNodes[0], { width: n, height: o }, he, fe],
                      $(
                          t,
                          t
                ...
                : [[t, { width: n, height: o, x: e, y: l }, he, fe]]
        );
    }
    function it(t, e, i) {
    ...
    function nt(t, e, i, n, a) {
        var s = [],
            r = i
                ...
                .join("L");
        a && (r = x(e, i));
        var o = [t.path, { d: "M" + r }, ce, fe];
        if ((s.push(o), t.region)) {
            var l = e[0] + "," + n + "L",
                u = "L" + e.slice(-1)[0] + ", " + n,
                h = [t.region, { d: "M" + l + r + u }, ce, fe];
            s.push(h);
        }
        return s;
    }
    ...
    function ht(e) {
        ...
        var n = t.create("style", { innerHTML: ge });
    ...
    function bt(t) {
        var e = pt(t),
            i = e.getDay();
        return (0 !== i && xt(e, -1 * i), e);
    }
    function xt(t, e) {
        t.setDate(t.getDate() + e);
    }
    function kt(t, e, i) {
        var n = Object.keys(Te).filter(function (e) {
                return t.includes(e);
            }),
            a = Te[n[0]];
        return (Object.assign(a, { constants: e, getData: i }), new Pe(a));
    }
    function wt(t) {
        if (0 === t) return [0, 0];
    ...
    function Tt(t) {
        function e(t, e) {
            for (var i = Pt(t), n = i[1] - i[0], a = 0, s = 1; a < e; s++)
                ((a += n), i.unshift(-1 * a));
            return i;
        }
        var i = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
            n = Math.max.apply(Math, Vt(t)),
            a = Math.min.apply(Math, Vt(t)),
            s = [];
        if (n >= 0 && a >= 0) (wt(n)[1], (s = i ? Pt(n, a) : Pt(n)));
        else if (n > 0 && a < 0) {
            var r = Math.abs(a);
            n >= r
                ? (wt(n)[1], (s = e(n, r)))
            ...
            var o = Math.abs(a),
                l = Math.abs(n);
            (wt(o)[1],
                (s = (s = i ? Pt(o, l) : Pt(o)).reverse().map(function (t) {
                    return -1 * t;
                })));
        }
        return s;
    ...
    function Nt(t, e) {
        for (
            var i = Math.max.apply(Math, Vt(t)), n = 1 / (e - 1), a = [], s = 0;
            s < e;
            s++
        ) {
            var r = i * (n * s);
    ...
    function Et(t, e) {
        ...
        return (
            ...
            n.map(function (t) {
                ...
                t.chartType || (qt.includes(e), (t.chartType = e));
            }),
            t.yRegions &&
    ...
    var Ut = {
                ...
                jt(e, [
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            ((this.container = t.create("div", {
                                ...
                                this.hideTip(),
                                (this.title =
                                    this.container.querySelector(".title")),
                                (this.dataPointList =
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            ((this.top =
                                this.y - this.container.offsetHeight - 5),
        ...
        me = (function () {
            function e(t, i) {
                ...
                ((this.rawChartArgs = i),
                    ...
                    (this.measures = JSON.parse(JSON.stringify(Ut))));
                var n = this.measures;
                (this.setMeasures(i),
            ...
            return (
                jt(e, [
                    ...
                    { key: "calc", value: function () {} },
                    {
                        ...
                        value: function () {
                            ((this.baseWidth = a(this.parent)),
                                (this.width =
                                    this.baseWidth - u(this.measures)));
                        },
                    },
                    {
                        key: "makeChartArea",
                    ...
                    },
                    {
                        ...
                        value: function () {
                            this.config.isNavigable &&
                                (this.makeOverlay(), this.bindUnits());
                        },
                    },
                ...
                jt(e, [
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            ((e.labels = []),
                                a.map(function (t) {
                                    (e.sliceTotals.push(v(t[0])),
                                        e.labels.push(t[1]));
                                }),
                                (e.grandTotal = e.sliceTotals.reduce(function (
                                    t,
                                    e,
                                ) {
                                    return t + e;
                            ...
                            this.legendTotals.map(function (a, s) {
                                ...
                                var l = r * i + 5,
                                    h = t.config.truncateLegends
                                        ? y(e.labels[s], r / 10)
                                        : e.labels[s],
                                    c = t.config.formatTooltipY
                                        ? t.config.formatTooltipY(a)
                                        : a,
                                    d = I(
                                        l,
                                        n,
                ...
                jt(t, [
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            return (
                                t &&
                                    (e = this.animateElements(this.data) || []),
                                e
                            );
                        },
                    },
        ...
        Te = {
            ...
            pieSlices: {
                ...
                makeElements: function (t) {
                    return t.sliceStrings.map(function (e, i) {
                        var n = N(e, "pie-path", "none", t.colors[i]);
                        return ((n.style.transition = "transform .3s;"), n);
                    });
                },
                animateElements: function (t) {
            ...
            yAxis: {
                ...
                makeElements: function (t) {
                    ...
                    return t.positions.map(function (i, n) {
                        return V(i, t.labels[n], e.constants.width, {
            ...
            xAxis: {
                ...
                makeElements: function (t) {
                    var e = this;
                    return t.positions.map(function (i, n) {
                        return U(i, t.calcLabels[n], e.constants.height, {
                            mode: e.constants.mode,
                            pos: e.constants.pos,
                        });
                    });
            ...
            yMarkers: {
                ...
                makeElements: function (t) {
                    ...
                    return t.map(function (t) {
                        return G(t.position, t.label, e.constants.width, {
            ...
            barGraph: {
                layerClass: function () {
                    return (
                        "dataset-units dataset-bars dataset-" +
            ...
            lineGraph: {
                layerClass: function () {
                    return (
                        "dataset-units dataset-line dataset-" +
                        this.constants.index
                    );
                },
                makeElements: function (t) {
                        ...
                        value: function () {
                            ...
                            (e.sliceTotals.map(function (i, o) {
                                var l = r,
                                    ...
                                    y = void 0;
                                t.init
                                    ? ((m = g ? g.startPosition : f),
                                      (y = g ? g.endPosition : f))
                                    : ((m = f), (y = v));
                                var b =
                                    360 === u
                                        ? E(m, y, t.center, t.radius, a, h)
                                        : S(m, y, t.center, t.radius, a, h);
                        ...
                        value: function (t, i, n, a) {
                            if (t) {
                                ...
                                if (n) {
                                    (rt(
                                        t,
                                        this.calTranslateByAngle(
                                            this.state.slicesProperties[i],
                                        ),
                                    ),
                                        (t.style.fill = w(s, 50)));
                                    var r = e(this.svg),
                ...
                jt(e, [
                    {
                        ...
                        value: function (t) {
                            var e = this.measures;
                            ((this.discreteDomains =
                                0 === t.discreteDomains ? 0 : 1),
                                (e.paddings.top = 36),
                                (e.paddings.bottom = 0),
                                (e.legendHeight = 24),
                                (e.baseHeight = 12 * be + l(e)));
                            var i = this.data,
                                n = this.discreteDomains ? 12 : 0;
                            this.independentWidth =
                                12 * (ft(i.start, i.end) + n) + u(e);
                        },
                    },
                    {
                        key: "updateWidth",
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            if (
                                ...
                                var e = {};
                                (Object.keys(t.dataPoints).forEach(
                                    function (i) {
                                        var n = new Date(i * xe);
                                        e[dt(n)] = t.dataPoints[i];
                                    },
                                ),
                                    (t.dataPoints = e));
                            }
                    ...
                    },
                    {
                        ...
                        value: function () {
                            var t = this.state;
                            ((t.start = pt(this.data.start)),
                                (t.end = pt(this.data.end)),
                                (t.firstWeekStart = pt(t.start)),
                                (t.noOfWeeks = ft(t.start, t.end)),
                                (t.distribution = Nt(
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            xt((e = pt(e) || yt(n, a)), 1);
                            for (
                                var o = ft(s, e), l = [], u = void 0, h = 0;
                                h < o;
                                h++
                            )
                                ((u = this.getCol(s, n)),
                                    l.push(u),
                                    xt((s = new Date(u[be - 1].yyyyMmDd)), 1));
                            return (
                                void 0 !== u[be - 1].dataValue &&
                                    (xt(s, 1), l.push(this.getCol(s, n, !0))),
                                (r.cols = l),
                                r
                            );
                        },
                ...
                jt(i, [
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            (It(
                                ...
                                (this.config.xAxisMode =
                                    t.axisOptions.xAxisMode || "span"),
                                (this.config.yAxisMode =
                                    t.axisOptions.yAxisMode || "span"),
                                (this.config.xIsSeries =
                                    t.axisOptions.xIsSeries || 0),
                                (this.config.shortenYAxisNumbers =
                                    t.axisOptions.shortenYAxisNumbers || 0),
                                (this.config.formatTooltipX =
                                    t.tooltipOptions.formatTooltipX),
                                (this.config.formatTooltipY =
                                    t.tooltipOptions.formatTooltipY),
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            t.datasets = this.data.datasets.map(
                                function (t, i) {
                                    var n = t.values,
                                        a = t.cumulativeYs || [];
                                    return {
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            ((t.yExtremes = new Array(t.datasetLength).fill(
                                9999,
                            )),
                    ...
                    },
                    {
                        ...
                        value: function () {
                            var t = this.state;
                            (this.data.yMarkers &&
                                (this.state.yMarkers = this.data.yMarkers.map(
                                    function (e) {
                                        return (
                                            (e.position = Ot(e.value, t.yAxis)),
                                            e.options || (e.options = {}),
                                            e
                                        );
                                    },
                                ...
                                this.data.yRegions &&
                                    (this.state.yRegions =
                                        this.data.yRegions.map(function (e) {
                                            return (
                                                (e.startPos = Ot(
                                                    e.start,
                                                    t.yAxis,
                                                )),
                                                (e.endPos = Ot(e.end, t.yAxis)),
                                                e.options || (e.options = {}),
                                                e
                                            );
                                        })));
                            ...
                            ((this.dataUnitComponents = []),
                                (this.components = new Map(
                                    e
                                        ...
                                        .map(function (e) {
                                            var i = kt.apply(void 0, Vt(e));
                                            return (
                                                (e[0].includes("lineGraph") ||
                                                    e[0].includes(
                                                        "barGraph",
                                                    )) &&
                                                    t.dataUnitComponents.push(
                                                        i,
                                                    ),
                                                [e[0], i]
                                            );
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            var e = this.state;
                            if (e.yExtremes) {
                                var i = Dt(t, e.xAxis.positions, !0);
                                if (i >= 0) {
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            (this.overlayGuides &&
                                ...
                                (this.overlayGuides =
                                    this.dataUnitComponents.map(function (t) {
                                        return {
                                            type: t.unitType,
                                            overlay: void 0,
                                            units: t.units,
                            ...
                            (this.dataUnitComponents.map(function (e) {
                                e.units.map(function (e) {
                                    e.addEventListener("click", function () {
                                        var i =
                                            e.getAttribute("data-point-index");
                                        t.setCurrentDataPoint(i);
                                    });
                                });
                            }),
                                this.tip.container.addEventListener(
                                    "click",
                                    function () {
                                        var e =
                                            t.tip.container.getAttribute(
                                                "data-point-index",
                                            );
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            var e = this.state;
                            ((t = parseInt(t)) < 0 && (t = 0),
                                t >= e.xAxis.labels.length &&
                                    (t = e.xAxis.labels.length - 1),
                                t !== e.currentIndex &&
                                    ((e.currentIndex = t),
                                    s(
                                        this.parent,
        ...
        Se = function t(e, i) {
            return (Ft(this, t), Wt(i.type, e, i));
        },
        Ee = Object.freeze({
            Chart: Se,
            PercentageChart: Le,
        ...
        _e = {};
    return (
        (_e.NAME = "Frappe Charts"),
        (_e.VERSION = "1.5.6"),
        (_e = Object.assign({}, _e, Ee))
    );
})();
